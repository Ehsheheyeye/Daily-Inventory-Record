...
// New function for exporting data as a CSV file
function downloadRecords() {
  let csvContent = "Entry No,Date,Time,Client Location,Work Description\n";
  records.forEach(record => {
    const row = `${record.entryNo},${record.date},${record.time},${record.clientLocation},${record.workDescription.replace(/,/g, " ")}\n`;
    csvContent += row;
  });
  ...
  downloadAnchor.setAttribute("download", "inventory_records.csv");
